...
작성과정은 풀스택쪽에서 주로 js 및 자바를 배웠던터라 ai 과정중에나 지금도 파이썬을 공부하면서 짜고 있고 아직은 클로드 코드를 이용한 비중이 높아서 더 이해하면서 짜려고 하고 있습니다.
...
- 🧠 **소프트 LLM 검사(gpt-4-o-mini)**: 위 하드 룰 통과시 AI 기반 soft llm 체크. DTO/Schema 위반, 의존성 위험, 권한 변경 감지 등 판단하여 finding에 반영(보안 / 아키텍처 외 부적절한 의존성등을 유연성있게 체크)
