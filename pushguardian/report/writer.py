...
def generate_report_md(
    ...
    if findings:
        ...
        md_lines.append("## ✅ No Critical Findings\n\n")

    # Quick fixes
    if quick_fixes:
        md_lines.append("## 🔧 Quick Action Items\n")
    ...
    if findings and evidence.principle_links:
        md_lines.append("## 🔒 Security Resources\n")
    ...
    if weak_stack_touched and learning_points:
        ...
        md_lines.extend(
            [
                "## 📖 Learning: Weak Stack Detected\n",
                f"⚠️ This change touches **{', '.join(weak_stack_touched)}** which you're less familiar with.\n\n",
                "### 🎯 Fundamental Concepts in Your Code\n",
            ]
        )
        ...
        if evidence.example_links:
            md_lines.append("### 💡 Tutorials & Examples\n")
    ...
    md_lines.extend(
        [
            "---\n",
            "*Generated by [PushGuardian](https://github.com/yourusername/pushguardian)*\n",
        ]
    )
